                  ...
                  <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                      <div class="team-member d-flex align-items-start">
                          ...
                          <div class="member-info">
                              ...
                              <div class="social">
                                  <a href="https://x.com/ELDER128US?t=kxzGtDlDeeSNt77nfA8FUQ&s=09"><i
                                          class="bi bi-twitter-x"></i></a>
                                  <a href="https://www.facebook.com/share/1BR2ok1t69"><i
                                          class="bi bi-facebook"></i></a>
                                  <a href="https://www.instagram.com/usmanelder128?igsh=Yms2ZHY1dDN3c2Uz"><i
                                          class="bi bi-instagram"></i></a>
                                  <a href="https://www.tiktok.com/@usmanelder128?_t=ZS-90SkMlVT2t6&_r=1"><i
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="email" id="login-field" class="form-control"
                            placeholder="Enter your login ID" value="{{ old('email') }}">
        ...
        <div class="col-lg-7">
            ...
            <div class="card-body">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-md-6">
                    <label for="password_confirmation" class="pb-2 fw-semibold">Confirm Password</label>
                    <input type="password" class="form-control"
